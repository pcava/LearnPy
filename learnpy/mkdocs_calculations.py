# learnpy/mkdocs_calculations.py
...
Examples:
    >>> from learnpy import mkdocs_calculations
    >>> mkdocs_calculations.add(2, 4)
    6.0
    >>> mkdocs_calculations.multiply(2.0, 4.0)
    8.0
    >>> from learnpy.mkdocs_calculations import divide
    >>> divide(4.0, 2)
    2.0
